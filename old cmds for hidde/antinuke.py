...
from backend.checks import Perms
from backend.utils import Whitelist
...
class AntiNuke(commands.Cog):
   ...
   async def sendlogs(self, action: str, member: discord.Member, punishment: str): 
    ...
    embed = discord.Embed(color=self.bot.color, title=f"{member} punished", description="Was delta fast? If yes, please give us a review in https://discord.gg/QpKVpXABxx")
