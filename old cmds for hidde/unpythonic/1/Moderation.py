    ...
    async def nickname(self, ctx, *, args=None):
        ...
        if args is None:
            await self.send_embed(
                ...
                "```Syntax: ,nickname @user (new_nickname)\nExample: ,nickname @user NewNickname```",
